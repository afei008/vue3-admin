...
<template>
  <a-row class="row">
    <a-col class="col" v-for="item in 4" :key="item">
      <a-card class="card">
        <div class="head">
        ...
        <div class="body flex jb ae">
          <span class="tip-up i-flex ac">周同比 <span class="data">{{ 12 }}%</span> </span>
          <span class="tip-down i-flex ac">日同比 <span class="data">{{ 11 }}%</span> </span>
        </div>
        <div class="foot">
